...
import {
  ...
  type BootstrapSlice,
} from "@/stores/slices/bootstrap-slice";
import {
  createAppShellSlice,
  type AppShellSlice,
} from "@/stores/slices/app-shell-slice";
import {
  createTaskCenterSlice,
  type TaskCenterSlice,
} from "@/stores/slices/task-center-slice";
import {
  createRepositorySlice,
  type RepositorySlice,
} from "@/stores/slices/repository-slice";
import {
  createTargetDetectionSlice,
  type TargetDetectionSlice,
} from "@/stores/slices/target-detection-slice";
